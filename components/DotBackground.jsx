export function DotBackground() {
    return (
        <div className='dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex h-full w-full items-center justify-center bg-backgroundColor dark:bg-backgroundColorDark'>
